        ...
        <ContentWrapper>
          <ContentContainer>
            <Description>
              ...
              기블을 사랑해주시는 고객 여러분.
              <br />
              저희는 개인 간 헌혈증 기부 플랫폼으로, 투명하고 빠른 방식으로
              헌혈증이 기부됨을 목표로 하고 있습니다.
              <br />
              <br />
              플랫폼의 원활한 운영을 위하여 고객 여러분께서는
              <br />
              헌혈증 기부 요청글 작성 및 기부 전 다음과 같은 사항을 유의하여
              주시길 바랍니다.
              <br />
              <br />
              <br />
              ...
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp; 기부된 모든 헌혈증은 투명하게 관리되며,
              사용 내역이 명확히 공개하여야 합니다.
              <br />
              <br />
              <span style={{ fontWeight: "bold", color: "#111" }}>
                2. 필요 개수
              ...
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp; 헌혈증 수령자께서는 필요한 만큼의 헌혈증
              개수만 기입할 것을 약속하며, <br />
              &nbsp;&nbsp;&nbsp;&nbsp; 추후 남은 헌혈증에 대한 조치도 적어주시길
              바랍니다.
              <br />
              <br />
              <span style={{ fontWeight: "bold", color: "#111" }}>
              ...
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp; 기부해 주신 분들은 사용 후기를 꼭 작성해
              주셔야합니다.
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp; 후기는 헌혈증이 올바르게 사용되었음을
              확인하는 중요한 자료와 원활한 플랫폼 운영에 큰 힘이 됩니다.
              <br />
              ...
              더 나은 서비스를 제공과 건강한 헌혈증 기부 문화 정착을 위해 항상
              노력하겠습니다.
              <br />
              <br />
              감사합니다.
