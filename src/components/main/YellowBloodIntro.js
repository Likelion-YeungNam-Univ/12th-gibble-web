...
const YellowBloodIntro = () => {
    const handleReissueClick = () => {
        window.location.href = 'https://bloodinfo.net/knrcbs/cm/cntnts/cntntsView.do?mi=1143&cntntsId=1023';
    };

    return (
        <Wrapper>
            <Box>
                <Image src={require('../../assets/main/Yellowpaper.png')} alt="노랑헌혈증서" />
                <Text>
                    <MainText>
                        헌혈증서, 재발급이 가능해졌어요
                    </MainText>
                    <SubText>
                        혈액관리법 개정에 따라 22.09.24 이후<br />
                        최초 발급된 헌혈증서 (노란색)부터 잃어버리거나 훼손되어<br />
